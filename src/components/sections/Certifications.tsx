  ...
  return (
    <section className="section-pad">
      <div className="container-narrow">
        <SectionHeading title="Certifications" subtitle="Compact verification of continuous upskilling." align="left" />
          ...
          {certifications.map((c) => (
            ...
            >
              <div className="mb-3 flex items-center gap-2">
                ...
                <span className="text-xs font-semibold text-[#8a90a8]">{c.issuer}</span>
              </div>
              <h3 className="text-[15px] font-semibold leading-snug text-[#f0f1f4]">{c.title}</h3>
              <a
                href={c.url}
