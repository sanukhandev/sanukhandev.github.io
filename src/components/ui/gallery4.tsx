      ...
      <div className="container mx-auto">
        <div className="mb-6 flex items-end justify-between md:mb-10 lg:mb-12">
          <div className="flex flex-col gap-3">
            <h2 className="text-3xl font-medium text-primary md:text-4xl lg:text-5xl">
              {title}
            </h2>
          ...
          <CarouselContent className="ml-0 2xl:ml-[max(8rem,calc(50vw-700px))] 2xl:mr-[max(0rem,calc(50vw-700px))]">
            {items.map((item) => (
              ...
              >
                ...
                >
                  <div className="relative h-full min-h-[24rem] max-w-full overflow-hidden rounded-xl border border-default/70 md:aspect-[5/4] lg:aspect-[4/3]">
                    <img
                      src={item.image}
                      alt={item.title}
                      ...
                      loading="lazy"
                    />
                    <div className="absolute inset-0 h-full bg-[linear-gradient(hsl(var(--background)/0),hsl(var(--background)/0.35),hsl(var(--background)/0.85)_100%)]" />
                    <div className="absolute inset-x-0 bottom-0 flex flex-col items-start p-5 text-primary md:p-6">
                      <div className="mb-2 pt-4 text-lg font-semibold md:text-xl">
                        {item.title}
                      </div>
                      <div className="mb-6 line-clamp-3 text-sm text-secondary md:mb-8">
                        {item.description}
                      </div>
